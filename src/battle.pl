...
boss_turn :-
    ...
    write('You feel tremendous joy as you enter the gate to Sinyalisisville. People cheered as you walk through the entrance'),nl,
    write('road. The city is majestic and it is better than the tales told by travellers. Seeing this beautiful sight, sometimes'),nl,
