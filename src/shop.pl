...
% ----- Armor -----
% Swordsman
armor_loot(0, 'Basic Iron Armor', 1, 0, 0, 0).
...
gacha(JobID) :-
    ...
    ; random(2, 3, LootType), 
        LootType =:= 2 ->
            % Selecting Item from Stock
            armor_stock(ArmorStock), length(ArmorStock, Stock),
